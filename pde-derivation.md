...
$$d\Pi = \left(\frac{\partial V}{\partial t}(S, t) +\mu S \frac{\partial V}{\partial S}(S, t) + \frac{1}{2} \sigma ^2 S^2 \frac{\partial ^2 V}{\partial S ^2} (S, t) - \Delta \mu S\right)dt + \sigma S \left( \frac{\partial V}{\partial S}(S, t) - \Delta \right)dW$$
...
$$d\Pi = \left(\frac{\partial V}{\partial t}(S, t) + \frac{1}{2} \sigma ^2 S^2 \frac{\partial ^2 V}{\partial S ^2} (S, t)\right)dt$$

All risk has been removed, meaning we can apply the no-arbitrage argument to deduce that the portfolio must grow at the risk free rate $r$, and hence $d\Pi = r\Pi dt$. Since $\Pi = V - \Delta S = V - \frac{\partial V}{\partial S}S$, we can also state that

$$d\Pi = r\left(V - \frac{\partial V}{\partial S} S\right)dt$$

These two expressions for $d\Pi$ can be set equal to each other

$$\left( \frac{\partial V}{\partial t}(S, t) + \frac{1}{2} \sigma ^2 S^2 \frac{\partial ^2 V}{\partial S ^2} (S, t)\right) dt = r\left(V - \frac{\partial V}{\partial S} S \right)dt$$
